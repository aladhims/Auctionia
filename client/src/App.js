...
class App extends Component {
  ...
  render() {
    return (
      <div>
        <Ldng/>
        <Route exact path='/login' component={(routeProps) => <Login {...routeProps} error={this.handleOpenSnack}/>}/>
        <Route exact path='/signup' component={(routeProps) => <Signup {...routeProps} error={this.handleOpenSnack}/>}/>
