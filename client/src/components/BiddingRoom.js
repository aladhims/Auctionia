...
class BiddingRoom extends Component {
    ...
    handleUpdateBid = () => {
        ...
        const bidsAmount = this.props.bidsQuery.getAuction.bidders.map(bid => bid.amount);
            ...
            this.setState(
              ...
              async function() {
                ...
                if(checkMyId === -1) {
                    ...
                    console.log("UPDATED")
                    const myBid = bidders.find(function(b) {return b.byId === myId} );
    ...
    render() {
        ...
        console.log(bidsQuery.getAuction.bidders)
        
        return (
            <Grid item xs={12} style={{marginTop: 24,height: 'calc(100vh - 130px)',}} >
                    ...
                    <Grid item xs={12} sm={12} md={4} lg={4}>
                        <Grid container justify="center" alignItems="stretch">
                            ...
                            <Grid container direction="row" justify="center" spacing={24}>
                                <FormControl margin="normal" error={this.state.error} aria-describedby="name-error-text">
                                    ...
                                    />
                                    <FormHelperText id="name-error-text">{this.state.errMsg}</FormHelperText>
                                </FormControl>
...
const gqlOperations = compose(
    graphql(AUCTION_DETAILS, {
        name: "bidsQuery",
        options: ({ location: { pathname} }) => ({ variables:  {id: pathname.split("/")[3].toString()} }),
    }),
    graphql(CREATE_BID, {
        name: "bidsCreate"
    }),
...
export default gqlOperations(withStyles(styles)(BiddingRoom));
