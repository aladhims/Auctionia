  ...
  render() {
    ...
    return (
        <Card className={classes.card}>
            ...
            action={
                <FormControlLabel
                    control={
                        ...
                        disabled={true}
                        checked={auction.status === 'PROGRESS' ? true: false}
                        />
                    }
                    label={auction.status === 'PROGRESS' ? 'Berlangsung': 'Selesai'}
                />
            }
          />
          <CardMedia
          ...
          />
          <CardContent>
            <Typography type="headline" component="h4" color="accent" gutterBottom={true}>
              {auction.title}
            </Typography>
            <Typography gutterBottom={true} className={classes.pos}>
              Harga tertinggi terakhir :  <em><b>{toRp(auction.currentprice)}</b></em>
            </Typography>
